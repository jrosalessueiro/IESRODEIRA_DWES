                ...
                <?php $__currentLoopData = $jugadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jugador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="text-start">
                            ...
                            <?php echo e(htmlspecialchars($jugador['apellidos'] . ', ' . $jugador['nombre'])); ?>

                        </td>
                        <td class="text-center">
                            <!-- Muestra la posición del jugador, obtenida a través del código de posición -->
                            <?php echo e(htmlspecialchars(getPositionByCod($jugador['posicion']))); ?>

                        </td>
                        <td class="text-center">
                            <!-- Muestra el dorsal del jugador o "Sin Asignar" si no tiene dorsal asignado -->
                            <?php echo e($jugador['dorsal'] ? htmlspecialchars($jugador['dorsal']) : 'Sin Asignar'); ?>

                        </td>
                        <td class="d-flex justify-content-center align-items-center">
                            <!-- Muestra el código de barras del jugador utilizando un gestor de códigos de barras -->
                            <?php echo e($barcodeManager->printCode(code: $jugador['barcode'])); ?>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ZZ-TEMP\MP0613-DWCS\TAREAS\GITHUB\Jose\IESRODEIRA_DWES\www\UD5\ParteB\views/vjugadores.blade.php ENDPATH**/ ?>